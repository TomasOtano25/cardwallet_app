...
class _CardCreate extends State<CardCreate> {
  ...
  void initState() {
    ...
    _cardMonthFocus = FocusNode();
    _cardYearFocus = FocusNode();
  }
  ...
  void dispose() {
    ...
    _cardMonthFocus.dispose();
    _cardYearFocus.dispose();
  ...
  Future<Null> _focusNodeListener() async {
    if(animatedStateKey.currentState.isFront == true && !_focusNode.hasFocus) {
      return;
    }
    ...
    final _cardHolderName = StreamBuilder(
      ...
      builder: (context, snapshot) {
        return TextField(
          ...
          focusNode: _cardHolderNameFocus,
          onSubmitted: (term) {
            _fieldFocusChange(context, _cardHolderNameFocus, _cardNumberFocus);
          },
      ...
      child: StreamBuilder(
        ...
        builder: (context, snapshot) {
          return TextField(
            ...
            focusNode: _cardNumberFocus,
            onSubmitted: (term) {
              _fieldFocusChange(context, _cardNumberFocus, _cardMonthFocus);
            },
            inputFormatters: [
      ...
      builder: (context, snapshot) {
        return Container(
          ...
          child: TextField(
            ...
            focusNode: _cardYearFocus,
            onSubmitted: (term) {
              _fieldFocusChange(context, _cardYearFocus, _focusNode);
            },
            decoration: InputDecoration(
              border: InputBorder.none,
              filled: true,
